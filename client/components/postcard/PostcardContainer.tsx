    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Flip hint */}
            <p
                className="text-center mt-3 font-sans text-[12px] text-ink-secondary opacity-80 tracking-wide select-none transition-opacity duration-200"
                aria-hidden="true"
            >
                {flipped ? "Turn it over see front" : "Tap to flip over"}
            </p>
        </div>
    );
}
